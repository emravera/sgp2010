    ...
    public partial class frmConjunto : Form
    {
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            ...
            if (dgvConjuntos.Rows.GetRowCount(DataGridViewElementStates.Selected) != 0)
            {
                ...
                DialogResult respuesta = MessageBox.Show("¿Está seguro que desea eliminar el conjunto seleccionado?", "Pregunta: Confirmar eliminación", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
