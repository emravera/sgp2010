...
namespace GyCAP.UI.Mantenimiento
{
    ...
    {
        private static frmMantenimiento _frmMantenimiento = null;
        ...
        public frmMantenimiento()
        {
            ...
            btnTipoMantenimiento.Tag = panelTipoMantenimiento;
            Size size = new Size(panelPlanMantenimiento.Size.Width, 0);
            panelPlanMantenimiento.Size = size;
            panelTipoMantenimiento.Size = size;
        }

        public static frmMantenimiento Instancia
        {
            get
            {
                if (_frmMantenimiento == null || _frmMantenimiento.IsDisposed)
                {
                    _frmMantenimiento = new frmMantenimiento();
                }
                else
                {
                    _frmMantenimiento.BringToFront();
                }
                return _frmMantenimiento;
            }
            set
            {
                _frmMantenimiento = value;
            }
        }
