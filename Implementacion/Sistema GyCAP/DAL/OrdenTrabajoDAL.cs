    ...
    {        
        public static void Insertar(OrdenTrabajo orden, SqlTransaction transaccion)
        {
            ...
            object[] valoresParametros = { 
                                             ...
                                             orden.CantidadReal,
                                             orden.FechaInicioEstimada.Value,
                                             orden.FechaFinEstimada.Value,
                                             orden.Observaciones,
                                             orden.Secuencia,
                                             hr,
                                             padre,
        ...
        public static void IniciarOrdenTrabajo(OrdenTrabajo ordenT, SqlTransaction transaccion)
        {
            ...
            object[] parametros = { ordenT.Estado.Codigo, 
                                     ordenT.FechaInicioReal.Value.ToString("yyyyMMdd"), 
                                     ordenT.Numero };
        ...
        public static void FinalizarOrdenTrabajo(OrdenTrabajo ordenT, SqlTransaction transaccion)
        {
            ...
            object[] parametros = { ordenT.Estado.Codigo, ordenT.FechaInicioReal.Value.ToString("yyyMMdd"), ordenT.CantidadReal, ordenT.FechaFinReal.Value.ToString("yyyyMMdd") };
