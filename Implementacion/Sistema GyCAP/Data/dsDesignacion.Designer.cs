...
namespace GyCAP.Data {
    ...
    public partial class dsDesignacion : global::System.Data.DataSet {
        ...
        public partial class DESIGNACIONESDataTable : global::System.Data.TypedTableBase<DESIGNACIONESRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            public DESIGNACIONESRow AddDESIGNACIONESRow(MARCASRow parentMARCASRowBydesignacion_marca_fk, string DESIG_NOMBRE) {
...
namespace GyCAP.Data.dsDesignacionTableAdapters {
    ...
    public partial class DESIGNACIONESTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[DESIGNACIONES] WHERE (([DESIG_CODIGO] = @Original_DESIG_CODIGO) AND ((@IsNull_MCA_CODIGO = 1 AND [MCA_CODIGO] IS NULL) OR ([MCA_CODIGO] = @Original_MCA_CODIGO)) AND ((@IsNull_DESIG_NOMBRE = 1 AND [DESIG_NOMBRE] IS NULL) OR ([DESIG_NOMBRE] = @Original_DESIG_NOMBRE)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[DESIGNACIONES] ([MCA_CODIGO], [DESIG_NOMBRE]) VALUES (@MCA_COD" +
                "IGO, @DESIG_NOMBRE);\r\nSELECT DESIG_CODIGO, MCA_CODIGO, DESIG_NOMBRE FROM DESIGNA" +
                "CIONES WHERE (DESIG_CODIGO = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[DESIGNACIONES] SET [MCA_CODIGO] = @MCA_CODIGO, [DESIG_NOMBRE] = @DESIG_NOMBRE WHERE (([DESIG_CODIGO] = @Original_DESIG_CODIGO) AND ((@IsNull_MCA_CODIGO = 1 AND [MCA_CODIGO] IS NULL) OR ([MCA_CODIGO] = @Original_MCA_CODIGO)) AND ((@IsNull_DESIG_NOMBRE = 1 AND [DESIG_NOMBRE] IS NULL) OR ([DESIG_NOMBRE] = @Original_DESIG_NOMBRE)));
SELECT DESIG_CODIGO, MCA_CODIGO, DESIG_NOMBRE FROM DESIGNACIONES WHERE (DESIG_CODIGO = @DESIG_CODIGO)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT DESIG_CODIGO, MCA_CODIGO, DESIG_NOMBRE FROM dbo.DESIGNACIONES";
        ...
        public virtual int Delete(decimal Original_DESIG_CODIGO, global::System.Nullable<decimal> Original_MCA_CODIGO, string Original_DESIG_NOMBRE) {
        ...
        public virtual int Insert(global::System.Nullable<decimal> MCA_CODIGO, string DESIG_NOMBRE) {
        ...
        public virtual int Update(global::System.Nullable<decimal> MCA_CODIGO, string DESIG_NOMBRE, decimal Original_DESIG_CODIGO, global::System.Nullable<decimal> Original_MCA_CODIGO, string Original_DESIG_NOMBRE, decimal DESIG_CODIGO) {
            if ((MCA_CODIGO.HasValue == true)) {
            ...
            this.Adapter.UpdateCommand.Parameters[2].Value = ((decimal)(Original_DESIG_CODIGO));
            if ((Original_MCA_CODIGO.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[3].Value = ((object)(0));
                this.Adapter.UpdateCommand.Parameters[4].Value = ((decimal)(Original_MCA_CODIGO.Value));
            }
            else {
            ...
            if ((Original_DESIG_NOMBRE == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[6].Value = ((string)(Original_DESIG_NOMBRE));
            }
            this.Adapter.UpdateCommand.Parameters[7].Value = ((decimal)(DESIG_CODIGO));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(global::System.Nullable<decimal> MCA_CODIGO, string DESIG_NOMBRE, decimal Original_DESIG_CODIGO, global::System.Nullable<decimal> Original_MCA_CODIGO, string Original_DESIG_NOMBRE) {
            return this.Update(MCA_CODIGO, DESIG_NOMBRE, Original_DESIG_CODIGO, Original_MCA_CODIGO, Original_DESIG_NOMBRE, Original_DESIG_CODIGO);
        }
    }
