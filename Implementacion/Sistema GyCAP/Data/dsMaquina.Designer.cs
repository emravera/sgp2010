            ...
            public string MODM_NOMBRE {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("El valor de la columna \'MODM_NOMBRE\' de la tabla \'MODELOS_MAQUINAS\' es DBNull.", e);
                    }
                }
                set {
            ...
            public string MODM_DESCRIPCION {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("El valor de la columna \'MODM_DESCRIPCION\' de la tabla \'MODELOS_MAQUINAS\' es DBNul" +
                                "l.", e);
                    }
                }
                set {
...
namespace GyCAP.Data.dsMaquinaTableAdapters {
    ...
    public partial class MAQUINASTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[MAQUINAS] ([MODM_CODIGO], [EMAQ_CODIGO], [FAB_CODIGO], [MAQ_NOMBRE], [MAQ_NUMEROSERIE], [MAQ_FECHAALTA], [MAQ_MARCA]) VALUES (@MODM_CODIGO, @EMAQ_CODIGO, @FAB_CODIGO, @MAQ_NOMBRE, @MAQ_NUMEROSERIE, @MAQ_FECHAALTA, @MAQ_MARCA);
SELECT MAQ_CODIGO, MODM_CODIGO, EMAQ_CODIGO, FAB_CODIGO, MAQ_NOMBRE, MAQ_NUMEROSERIE, MAQ_FECHAALTA, MAQ_MARCA FROM MAQUINAS WHERE (MAQ_CODIGO = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[MAQUINAS] SET [MODM_CODIGO] = @MODM_CODIGO, [EMAQ_CODIGO] = @EMAQ_CODIGO, [FAB_CODIGO] = @FAB_CODIGO, [MAQ_NOMBRE] = @MAQ_NOMBRE, [MAQ_NUMEROSERIE] = @MAQ_NUMEROSERIE, [MAQ_FECHAALTA] = @MAQ_FECHAALTA, [MAQ_MARCA] = @MAQ_MARCA WHERE (([MAQ_CODIGO] = @Original_MAQ_CODIGO) AND ([MODM_CODIGO] = @Original_MODM_CODIGO) AND ([EMAQ_CODIGO] = @Original_EMAQ_CODIGO) AND ([FAB_CODIGO] = @Original_FAB_CODIGO) AND ((@IsNull_MAQ_NOMBRE = 1 AND [MAQ_NOMBRE] IS NULL) OR ([MAQ_NOMBRE] = @Original_MAQ_NOMBRE)) AND ((@IsNull_MAQ_NUMEROSERIE = 1 AND [MAQ_NUMEROSERIE] IS NULL) OR ([MAQ_NUMEROSERIE] = @Original_MAQ_NUMEROSERIE)) AND ((@IsNull_MAQ_FECHAALTA = 1 AND [MAQ_FECHAALTA] IS NULL) OR ([MAQ_FECHAALTA] = @Original_MAQ_FECHAALTA)) AND ((@IsNull_MAQ_MARCA = 1 AND [MAQ_MARCA] IS NULL) OR ([MAQ_MARCA] = @Original_MAQ_MARCA)));
SELECT MAQ_CODIGO, MODM_CODIGO, EMAQ_CODIGO, FAB_CODIGO, MAQ_NOMBRE, MAQ_NUMEROSERIE, MAQ_FECHAALTA, MAQ_MARCA FROM MAQUINAS WHERE (MAQ_CODIGO = @MAQ_CODIGO)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT MAQ_CODIGO, MODM_CODIGO, EMAQ_CODIGO, FAB_CODIGO, MAQ_NOMBRE, MAQ_NUMEROSE" +
                "RIE, MAQ_FECHAALTA, MAQ_MARCA FROM dbo.MAQUINAS";
        ...
        public virtual int Delete(decimal Original_MAQ_CODIGO, decimal Original_MODM_CODIGO, decimal Original_EMAQ_CODIGO, decimal Original_FAB_CODIGO, string Original_MAQ_NOMBRE, string Original_MAQ_NUMEROSERIE, global::System.Nullable<global::System.DateTime> Original_MAQ_FECHAALTA, string Original_MAQ_MARCA) {
        ...
        public virtual int Insert(decimal MODM_CODIGO, decimal EMAQ_CODIGO, decimal FAB_CODIGO, string MAQ_NOMBRE, string MAQ_NUMEROSERIE, global::System.Nullable<global::System.DateTime> MAQ_FECHAALTA, string MAQ_MARCA) {
        ...
        public virtual int Update(
            ...
            this.Adapter.UpdateCommand.Parameters[7].Value = ((decimal)(Original_MAQ_CODIGO));
            this.Adapter.UpdateCommand.Parameters[8].Value = ((decimal)(Original_MODM_CODIGO));
            this.Adapter.UpdateCommand.Parameters[9].Value = ((decimal)(Original_EMAQ_CODIGO));
            this.Adapter.UpdateCommand.Parameters[10].Value = ((decimal)(Original_FAB_CODIGO));
            if ((Original_MAQ_NOMBRE == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[12].Value = ((string)(Original_MAQ_NOMBRE));
            }
            if ((Original_MAQ_NUMEROSERIE == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[14].Value = ((string)(Original_MAQ_NUMEROSERIE));
            }
            if ((Original_MAQ_FECHAALTA.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[15].Value = ((object)(0));
                this.Adapter.UpdateCommand.Parameters[16].Value = ((System.DateTime)(Original_MAQ_FECHAALTA.Value));
            }
            else {
            ...
            if ((Original_MAQ_MARCA == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[18].Value = ((string)(Original_MAQ_MARCA));
            }
            this.Adapter.UpdateCommand.Parameters[19].Value = ((decimal)(MAQ_CODIGO));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(decimal MODM_CODIGO, decimal EMAQ_CODIGO, decimal FAB_CODIGO, string MAQ_NOMBRE, string MAQ_NUMEROSERIE, global::System.Nullable<global::System.DateTime> MAQ_FECHAALTA, string MAQ_MARCA, decimal Original_MAQ_CODIGO, decimal Original_MODM_CODIGO, decimal Original_EMAQ_CODIGO, decimal Original_FAB_CODIGO, string Original_MAQ_NOMBRE, string Original_MAQ_NUMEROSERIE, global::System.Nullable<global::System.DateTime> Original_MAQ_FECHAALTA, string Original_MAQ_MARCA) {
            return this.Update(MODM_CODIGO, EMAQ_CODIGO, FAB_CODIGO, MAQ_NOMBRE, MAQ_NUMEROSERIE, MAQ_FECHAALTA, MAQ_MARCA, Original_MAQ_CODIGO, Original_MODM_CODIGO, Original_EMAQ_CODIGO, Original_FAB_CODIGO, Original_MAQ_NOMBRE, Original_MAQ_NUMEROSERIE, Original_MAQ_FECHAALTA, Original_MAQ_MARCA, Original_MAQ_CODIGO);
        }
    }
