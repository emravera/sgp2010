    ...
    public partial class frmPlanAnual : Form
    {
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            ...
            if (dgvLista.Rows.GetRowCount(DataGridViewElementStates.Selected) != 0)
            {
                ...
                DialogResult respuesta = MessageBox.Show("¿Ésta seguro que desea eliminar el Plan Anual seleccionada y todo su detalle ?", "Pregunta: Confirmar eliminación", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
