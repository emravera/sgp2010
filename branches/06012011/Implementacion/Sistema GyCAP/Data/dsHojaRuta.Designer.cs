    ...
    public partial class CENTROS_TRABAJOSTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[CENTROS_TRABAJOS] WHERE (([CTO_CODIGO] = @Original_CTO_CODIGO)" +
                ...
                "Original_CTO_CAPACIDADUNIDADHORA)))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_CTO_CODIGO", global::System.Data.SqlDbType.Decimal, 0, global::System.Data.ParameterDirection.Input, 10, 0, "CTO_CODIGO", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
...
SELECT CTO_CODIGO, CTO_NOMBRE, SEC_CODIGO, CT_TIPO, CTO_HORASTRABAJONORMAL, CTO_HORASTRABAJOEXTENDIDO, CTO_ACTIVO, CTO_DESCRIPCION, CTO_CAPACIDADCICLO, CTO_HORASCICLO, CTO_TIEMPOANTES, CTO_TIEMPODESPUES, CTO_EFICIENCIA, CTO_COSTOHORA, CTO_COSTOCICLO, CTO_CAPACIDADUNIDADHORA FROM CENTROS_TRABAJOS WHERE (CTO_CODIGO = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[CENTROS_TRABAJOS] SET [CTO_NOMBRE] = @CTO_NOMBRE, [SEC_CODIGO] = @S" +
                ...
                "CAPACIDADUNIDADHORA] = @CTO_CAPACIDADUNIDADHORA WHERE (([CTO_CODIGO] = @Original" +
                "_CTO_CODIGO) AND ((@IsNull_CTO_NOMBRE = 1 AND [CTO_NOMBRE] IS NULL) OR ([CTO_NOM" +
                "BRE] = @Original_CTO_NOMBRE)) AND ((@IsNull_SEC_CODIGO = 1 AND [SEC_CODIGO] IS N" +
                "ULL) OR ([SEC_CODIGO] = @Original_SEC_CODIGO)) AND ([CT_TIPO] = @Original_CT_TIP" +
                "O) AND ((@IsNull_CTO_HORASTRABAJONORMAL = 1 AND [CTO_HORASTRABAJONORMAL] IS NULL" +
                ") OR ([CTO_HORASTRABAJONORMAL] = @Original_CTO_HORASTRABAJONORMAL)) AND ((@IsNul" +
                "l_CTO_HORASTRABAJOEXTENDIDO = 1 AND [CTO_HORASTRABAJOEXTENDIDO] IS NULL) OR ([CT" +
                "O_HORASTRABAJOEXTENDIDO] = @Original_CTO_HORASTRABAJOEXTENDIDO)) AND ((@IsNull_C" +
                "TO_ACTIVO = 1 AND [CTO_ACTIVO] IS NULL) OR ([CTO_ACTIVO] = @Original_CTO_ACTIVO)" +
                ") AND ((@IsNull_CTO_DESCRIPCION = 1 AND [CTO_DESCRIPCION] IS NULL) OR ([CTO_DESC" +
                "RIPCION] = @Original_CTO_DESCRIPCION)) AND ((@IsNull_CTO_CAPACIDADCICLO = 1 AND " +
                "[CTO_CAPACIDADCICLO] IS NULL) OR ([CTO_CAPACIDADCICLO] = @Original_CTO_CAPACIDAD" +
                "CICLO)) AND ((@IsNull_CTO_HORASCICLO = 1 AND [CTO_HORASCICLO] IS NULL) OR ([CTO_" +
                "HORASCICLO] = @Original_CTO_HORASCICLO)) AND ((@IsNull_CTO_TIEMPOANTES = 1 AND [" +
                "CTO_TIEMPOANTES] IS NULL) OR ([CTO_TIEMPOANTES] = @Original_CTO_TIEMPOANTES)) AN" +
                "D ((@IsNull_CTO_TIEMPODESPUES = 1 AND [CTO_TIEMPODESPUES] IS NULL) OR ([CTO_TIEM" +
                "PODESPUES] = @Original_CTO_TIEMPODESPUES)) AND ((@IsNull_CTO_EFICIENCIA = 1 AND " +
                ...
                "Original_CTO_COSTOHORA)) AND ((@IsNull_CTO_COSTOCICLO = 1 AND [CTO_COSTOCICLO] I" +
                "S NULL) OR ([CTO_COSTOCICLO] = @Original_CTO_COSTOCICLO)) AND ((@IsNull_CTO_CAPA" +
                "CIDADUNIDADHORA = 1 AND [CTO_CAPACIDADUNIDADHORA] IS NULL) OR ([CTO_CAPACIDADUNI" +
                "DADHORA] = @Original_CTO_CAPACIDADUNIDADHORA)));\r\nSELECT CTO_CODIGO, CTO_NOMBRE," +
                " SEC_CODIGO, CT_TIPO, CTO_HORASTRABAJONORMAL, CTO_HORASTRABAJOEXTENDIDO, CTO_ACT" +
                "IVO, CTO_DESCRIPCION, CTO_CAPACIDADCICLO, CTO_HORASCICLO, CTO_TIEMPOANTES, CTO_T" +
                "IEMPODESPUES, CTO_EFICIENCIA, CTO_COSTOHORA, CTO_COSTOCICLO, CTO_CAPACIDADUNIDAD" +
                "HORA FROM CENTROS_TRABAJOS WHERE (CTO_CODIGO = @CTO_CODIGO)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
        ...
        public virtual int Update(
            ...
            this.Adapter.UpdateCommand.Parameters[20].Value = ((decimal)(Original_CT_TIPO));
            if ((Original_CTO_HORASTRABAJONORMAL.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[21].Value = ((object)(0));
            ...
            if ((Original_CTO_CAPACIDADUNIDADHORA.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[44].Value = ((decimal)(Original_CTO_CAPACIDADUNIDADHORA.Value));
            }
            else {
                this.Adapter.UpdateCommand.Parameters[43].Value = ((object)(1));
                this.Adapter.UpdateCommand.Parameters[44].Value = global::System.DBNull.Value;
            }
            this.Adapter.UpdateCommand.Parameters[45].Value = ((decimal)(CTO_CODIGO));
            global::System.Data.ConnectionState previousConnectionState = this.Adapter.UpdateCommand.Connection.State;
            if (((this.Adapter.UpdateCommand.Connection.State & global::System.Data.ConnectionState.Open) 
                        != global::System.Data.ConnectionState.Open)) {
                this.Adapter.UpdateCommand.Connection.Open();
