    ...
    public partial class frmMateriaPrimaPrincipal : Form
    {
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            ...
            if (dgvLista.Rows.GetRowCount(DataGridViewElementStates.Selected) != 0)
            {
                ...
                DialogResult respuesta = MessageBox.Show("¿Está seguro que desea eliminar la Materia Prima Principal seleccionado?", "Pregunta: Confirmar eliminación", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
